...
def detect_maturity_level(image_path):
    ...
    maturity_levels = ['matang', 'mentah', 'setengah-matang']
    ...
    responses = {
            "predictions": [
                {
                    "type": "mentah",
                    "value": str(round(predictions[0][1], 4))
                },

                {
                    "type": "setengah-matang",
                    "value": str(round(predictions[0][2], 4))
                },

                {
                    "type": "matang",
                    "value": str(round(predictions[0][0], 4))
                },
            ],
